...
class cadanganpanganExport implements FromView, ShouldAutoSize, WithEvents
{
    protected $ta;
    ...
    {
        return view('cadanganpangan.export', [
            'cadanganpangan' => cadanganpangan::whereYear('created_at','like','%'. $this->ta .'%')->get()
        ]);
    }
}
