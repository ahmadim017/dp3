...
<div class="col-md-12">
  <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="collapseCardExample">
        <div class="card-body">
	<form action="{{route('cadanganpangan.store')}}" method="POST" enctype="multipart/form-data">
	@csrf
<div class="table-responsive">
<table class="table">
    <tr>
      <th class="bg-light" width="250">Stock Awal</th>
     
  <td colspan="3"><div class="input-group col-6">
              		<input type="number" name="stockawal" value="{{$stockakhir}}" placeholder="stock awal" class="form-control {{$errors->first('stockawal') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
...
<td colspan="3"><div class="input-group col-6">
              		<input type="number" name="pengadaan" value="{{old('pengadaan')}}" placeholder="pengadaan" class="form-control {{$errors->first('pengadaan') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">        		
			<div class="input-group-append">
                			<span class="input-group-text">Kg</span>
              		</div>
			</div>
...
<td>  
    <div class="col-6">
        <input type="text" class="form-control {{$errors->first('nokontrak') ? "is-invalid" : ""}}" name="nokontrak" value="{{old('nokontrak')}}" placeholder="isi Nomor Kontrak">
...
<td>  
  <div class="col-6">
      <input type="date" class="form-control {{$errors->first('tglkontrak') ? "is-invalid" : ""}}" name="tglkontrak" value="{{old('tglkontrak')}}" placeholder="isi Tanggal Kontrak">
