        ...
        <div class="col-md-7 col-xs-7 mb-2">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($spaces->file)
                                <strong><a href="{{asset('storage/filependukung/'.$spaces->file)}}" target="_blank" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-download" viewBox="0 0 16 16">
                ...
                <div class="card-footer">
                    <a href="{{ route('map.index') }}" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace" viewBox="0 0 16 16">
