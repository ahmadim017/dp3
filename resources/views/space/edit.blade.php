                    ...
                    <div class="card-body">
                        <form action="{{ route('space.update',$space) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="alamat" value="{{ $space->alamat }}" class="form-control @error('alamat') is-invalid @enderror" id="">
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3 mt-3">
                                ...
                                <input type="text" name="jumlah" value="{{ $space->jumlah }}" class="form-control @error('jumlah') is-invalid @enderror" id="">
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <img id="previewImage" class="mb-2" src="{{ $space->getImage() }}" width="20%" alt="">
