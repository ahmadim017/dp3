...
<title>Daftar Usulan Penerima Bantuan</title>
</head>
<body>
    <div class="container">
        <table width="100%">
        ...
        <h3 align="center">Daftar Usulan Penerima Bantuan</h3>
  ...
  <tbody>
    ...
    <tr>
          ...
          <td align="center">{{$u->nik}}</a></td>
          <td align="center">{{$u->nama}}</td>
          <td align="center">{{$u->tgllahir}}</td>
          <td align="center">{{$u->jeniskelamin}}</td>
