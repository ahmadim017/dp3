            ...
            <div class="col-12">
                <div class="card rounded">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('keamananpanganmasyarakat.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
			    ...
			    <div class="form-group mb-3">
                                ...
                                <input type="date" name="tglpelaksanaan" class="form-control @error('tglpelaksanaan') is-invalid @enderror" id="">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
