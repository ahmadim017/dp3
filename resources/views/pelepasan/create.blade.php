...
<div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark">Daftar Penerima Pelepasan Cadangan Pangan</h6>
      </div>
          ...
          <th scope="col">Aksi</th>
            ...
            <tbody>
              ...
              <tr>
                    ...
                    <td>{{$f->jumlah}}</td>
                    <td>
                    <a href="{{route('pelepasan.edit',[$f->id])}}" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="{{route('pelepasan.import',[$cadanganpangan->id])}}" method="POST" enctype="multipart/form-data">
            @csrf
