...
<div class="col-md-12">
  <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="collapseCardExample">
        <div class="card-body">
	<form action="{{route('nbmtahun.store')}}" method="POST" enctype="multipart/form-data">
	@csrf
...
<td colspan="3"><div class="input-group col-6">
  ...
  <td colspan="3"><div class="input-group col-6">
              		<input type="text" name="kalori" value="{{old('kalori')}}" placeholder="ketersediaan" class="form-control {{$errors->first('kalori') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
                        </div>
...
<td colspan="3"><div class="input-group col-6">
              		<input type="text" name="protein" value="{{old('protein')}}" placeholder="protein" class="form-control {{$errors->first('protein') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
              		              		</div>
  ...
  <td colspan="3"><div class="input-group col-6">
              		<input type="text" name="lemak" value="{{old('lemak')}}" placeholder="lemak" class="form-control {{$errors->first('lemak') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
                         </div>
