...
<div class="col-md-12">
  <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="collapseCardExample">
        <div class="card-body">
	<form action="{{route('pphkonsumsitahun.update',[$pphkonsumsitahun->id])}}" method="POST" enctype="multipart/form-data">
	@csrf
  @method('PUT')
...
<select name="tahun" class="form-control {{$errors->first('tahun') ? "is-invalid" : ""}}" >
  @foreach($tahun as $k)
    <option @if ($pphkonsumsitahun->tahun == $k->tahun) selected 
...
<td colspan="3"><div class="input-group col-6">
              <input type="text" name="ake" value="{{$pphkonsumsitahun->ake}}" placeholder="ake" class="form-control {{$errors->first('ake') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
                    </div>
...
<tr>
  ...
  <td colspan="3"><div class="input-group col-6">
              		<input type="text" name="akp" value="{{$pphkonsumsitahun->akp}}" placeholder="akp" class="form-control {{$errors->first('akp') ? "is-invalid" : ""}}" aria-describedby="basic-addon2">
                        </div>
