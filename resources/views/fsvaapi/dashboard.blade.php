  ...
  map.getContainer().appendChild(tooltip);
    ...
    var data = [
        @foreach ($fsva as $key => $value) 
            {"kelurahan": "{!! $value->kelurahan !!}", "indexprioritas": {!! $value->indexprioritas !!},"penyediaanpangan": {!! $value->penyediaanpangan !!},"kesejahteraanrendah": {!! $value->kesejahteraanrendah !!},"aksespenghubung": {!! $value->aksespenghubung !!},"aksesairbersih": {!! $value->aksesairbersih !!},"jmltenagakesehatan": {!! $value->jmltenagakesehatan !!},"luaslahanpertanian": {!! $value->luaslahanpertanian !!}  },
        @endforeach            
    ];
    ...
    onEachFeature: function(feature, layer) {
       ...
       for (var i = 0; i < data.length; i++) {
            if (data[i].kelurahan === kelurahan) {
                ...
                luaslahanpertanian = data[i].luaslahanpertanian;
                break;
            }
        }
        ...
        <table class="table table-striped" border="0">
            ...
            <tbody>
                ...
                <tr>
                    <td><b>Rasio Sarana Penyediaan Pangan</b></td>
                    <td>${penyediaanpangan}</td>
                </tr>
                <tr>
                    <td><b>Rasio Penduduk Miskin Desil 1</b></td>
                    <td>${kesejahteraanrendah}</td>
                </tr>
                <tr>
                    <td><b>Rasio Akses Penghubung Tidak Memadai</b></td>
                    <td>${aksespenghubung}</td>
                </tr>
                <tr>
                    <td><b>Rasio Rumah Tangga Tanpa Air Bersih</b></td>
                    <td>${aksesairbersih}</td>
                </tr>
                <tr>
                    <td><b>Rasio Tenaga Kesehatan</b></td>
                    <td>${jmltenagakesehatan}</td>
                </tr>
                <tr>
                    <td><b>Rasio Luas Lahan Pertanian</b></td>
                    <td>${luaslahanpertanian}</td>
                </tr>
            </tbody>
        </table>
    </div>
